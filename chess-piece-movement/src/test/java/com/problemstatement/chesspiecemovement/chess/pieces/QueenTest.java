...
public class QueenTest {
    ...
    void testQueenMoveFromCenter() {
        ChessPiece queen = new Queen("F2", Color.WHITE);
    ...
    void testQueenMoveFromBottomLeftCorner(){
        ChessPiece queen = new Queen("A1",Color.WHITE);
    ...
    void testQueenMoveFromTopRightCorner(){
        ChessPiece queen = new Queen("H8",Color.WHITE);
    ...
    void testQueenLowerCaseInputPosition(){
        ChessPiece queen = new Queen("e1",Color.BLACK);
